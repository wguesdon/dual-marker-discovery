...
Anything in `outputs/` is a literature synthesis, not pipeline output. It is not regenerated by any script
here, and a claim from it enters the report only once checked against the cited primary source. See
`outputs/README.md`.
